...
import {
  ...
  Dumbbell,
  Trophy,
  Dribbble as BasketballIcon  // ✅ REAL icon replacement for basketball
} from "lucide-react";
...
const categories = [
  ...
  },
  {
    id: 7,
    name: "Basketball",
    icon: BasketballIcon,     // ✅ Clean and valid icon
    description: "Basketballs, court wear & gear.",
  ...
  },
  {
    ...
    name: "Other Sports",
    icon: Trophy,
    description: "All sports wear & accessories.",

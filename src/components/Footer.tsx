    ...
    <footer className="bg-gradient-to-br from-primary to-primary/90 text-primary-foreground">
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              />
              <span className="text-xl font-semibold">JAIHIND SPORTS</span>
            </div>

            <p className="text-xs text-primary-foreground/80 leading-relaxed">
              Your trusted partner for premium sports gear. Built for champions to perform at their best.
            </p>
              ...
              <ul className="space-y-1">
                {section.links.map((link) => (
                  <li key={link.name}>
                    <a
                      href={link.href}
                      className="text-primary-foreground/80 hover:text-secondary text-xs transition-colors"
                    >
                      {link.name}
                    </a>
                  </li>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
          ...
          <p className="text-primary-foreground/70 text-center sm:text-right">
